      ...
      <main className="flex-1 w-full max-w-5xl mx-auto bg-white flex flex-col shadow-[0px_5px_15px_rgba(0,0,0,0.2)] animate-fade-up" style={{ "--animation-delay": "0.03s" }}>
        ...
        <div className="relative w-full">
          <DummyImage
            ...
            alt="Warung Naswa restaurant exterior"
          />
        ...
        <section className="px-4 sm:px-8 py-5 sm:py-6 border-b border-[#d9d9d9]">
          <div className="flex flex-col gap-3">
            ...
            <div className="[font-family:'Playfair-Black',Helvetica] font-black text-[#454545] text-base sm:text-lg">
              📍 Jalan Pembangunan
            </div>
        ...
        <section className="px-4 sm:px-8 pt-4 pb-8 sm:pt-6 sm:pb-10">
          <div className="[font-family:'Playfair-Black',Helvetica] font-black text-[#387647] text-2xl sm:text-3xl mb-4">
            Menu (12)
          </div>
            ...
            {menuItems.map((item) => (
              ...
              >
                <DummyImage
                  ...
                  alt={item.name}
                />
                <div className="[font-family:'Playfair-Black',Helvetica] font-black text-sm sm:text-base leading-tight mb-1">
                  {item.name}
                </div>
                <div className="[font-family:'Playfair-Black',Helvetica] font-black text-xs sm:text-sm">
                  {item.price}
                </div>
              </article>
            ))}
